...
// Load sprites
ghostSprites.head.up.src =
  "https://raw.githubusercontent.com/jaylikesbunda/ghost-snake/main/sprites/ghost-up.png";
ghostSprites.head.down.src =
  "https://raw.githubusercontent.com/jaylikesbunda/ghost-snake/main/sprites/ghost-down.png";
ghostSprites.head.left.src =
  "https://raw.githubusercontent.com/jaylikesbunda/ghost-snake/main/sprites/ghost-left.png";
ghostSprites.head.right.src =
  "https://raw.githubusercontent.com/jaylikesbunda/ghost-snake/main/sprites/ghost-right.png";
ghostSprites.body.src =
  "https://raw.githubusercontent.com/jaylikesbunda/ghost-snake/main/sprites/ghost-trail.png";
ghostSprites.food.src =
  "https://raw.githubusercontent.com/jaylikesbunda/ghost-snake/main/sprites/ghost-food.png";
...
function generateBombs() {
  ...
  for (let i = 0; i < bombCount; i++) {
    ...
    do {
      ...
      snake.some(
        (segment) =>
          segment.x === bombPosition.x && segment.y === bombPosition.y
      ) ||
      (food.x === bombPosition.x && food.y === bombPosition.y) ||
      bombs.some(
        (bomb) => bomb.x === bombPosition.x && bomb.y === bombPosition.y
      )
    );
...
function toggleMute() {
  ...
  Howler.mute(isMuted);
  document.getElementById("muteBtn").innerHTML = `<i class="ri-${
